<?php include_once 'includes/header.php';
	$_company = $company->get_company($_GET['cid']);
		...
		<div class="col-md-6 col-lg-6 col-sm-12 offset-md-3">
			...
			<div class="card">
				<div class="card-header">
					<h5 class="text-primary">Edit Company Detail</h5>
				</div>
				<div class="card-body">
					<form method="post" id="company_form">
						...
						<div class="form-group">
							...
							<input type="text" name="company_name" class="form-control required" value="<?=$_company['company_name']?>">
						...
						<div class="form-group">
							...
							<input type="text" name="address1" class="form-control required" value="<?=$_company['address1']?>">
						...
						<div class="form-group">
							...
							<input type="text" name="address2" class="form-control" value="<?=$_company['address2']?>">
						</div>
						<div class="row">
							<div class="col-md-6 col-lg-6 col-sm-12">
								<div class="form-group">
									<label>City <span class="text-danger">*</span></label>
									<input type="text" name="city" class="form-control required" value="<?=$_company['city']?>">
							...
							<div class="col-md-6 col-lg-6 col-sm-12">
								<div class="form-group">
									...
									<input type="text" name="zipcode" class="form-control required" value="<?=$_company['zipcode']?>">
						...
						<div class="form-group">
							...
							<input type="text" name="state" class="form-control required" value="<?=$_company['state']?>">
						...
						<div class="form-group">
							...
							<input type="text" name="country" class="form-control required" value="<?=$_company['country']?>">
